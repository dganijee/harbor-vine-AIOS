"""
google_calendar.py — Google Calendar data connector (sandbox / offline-branch)
...
Note: the calendar fixture deliberately includes 2 overlapping showings
between Jess Holloway and Tomás Vidal — pain point #3 in the intake.
The dashboard's anomaly_detection module surfaces these.
"""
