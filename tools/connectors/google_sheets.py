"""
google_sheets.py — Google Sheets data connector (sandbox / offline-branch)
...
For Harbor & Vine this fixture carries the pipeline tracker (~23 deals,
$12.4M open volume) and the headline metrics (active_listings,
pipeline_volume_usd, avg_days_on_market).
"""
...
class GoogleSheetsConnector(BaseConnector):
    ...
    def connect(self, credentials: dict) -> bool:
        ...
        Stage 2/3 this will run the service-account share flow and set
        `active: True`.
        """
        return False
